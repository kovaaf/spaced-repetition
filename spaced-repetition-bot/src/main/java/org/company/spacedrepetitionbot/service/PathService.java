...
public class PathService {
    ...
    public boolean isFileInSourceFolder(String filePath, List<String> sourceFolders) {
        if (sourceFolders == null || sourceFolders.isEmpty()) return true;
        String normalizedPath = normalizePath(filePath);
        return sourceFolders.stream().anyMatch(folder ->
                normalizedPath.startsWith(normalizePath(folder) + "/") ||
    ...
    public boolean isFileIncluded(String filePath, List<String> sourceFolders, List<String> excludeFolders) {
        ...
        if (excludeFolders == null || excludeFolders.isEmpty()) return true;

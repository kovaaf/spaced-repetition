...
public class KeyboardManager {
    ...
    public InlineKeyboardMarkup getAddDeckKeyboard() {
        List<InlineKeyboardButton> buttons = List.of(button(Callback.DECK_LIST.getText(), Callback.DECK_LIST.getAlias()));
    ...
    public InlineKeyboardMarkup getAddCardKeyboard(Long deckId) {
        List<InlineKeyboardButton> buttons = List.of(
                button(Callback.DECK_MENU.getText(),
    ...
    public InlineKeyboardMarkup getLearnDeckKeyboard(Long cardId, Long deckId, Status currentStatus) {
        List<InlineKeyboardButton> buttons = new ArrayList<>(List.of(
                button(Callback.SHOW_ANSWER.getText(), Callback.SHOW_ANSWER.getAlias() + CALLBACK_DELIMITER.getAlias() + cardId + CALLBACK_DELIMITER.getAlias() + deckId),
                button(Callback.PREVIOUS.getText(), Callback.PREVIOUS.getAlias() + CALLBACK_DELIMITER.getAlias() + cardId),
                button(Callback.EDIT_EXISTING_CARD.getText(),
                        Callback.EDIT_EXISTING_CARD.getAlias() + CALLBACK_DELIMITER.getAlias() + cardId)

        ));

//        if (currentStatus == Status.BURIED) {
//            buttons.add(button(Callback.UNBURY.getText(), Callback.UNBURY.getAlias() + CALLBACK_DELIMITER.getAlias() + cardId));
//        } else if (currentStatus == Status.SUSPENDED) {
//            buttons.add(button(Callback.UNSUSPEND.getText(), Callback.UNSUSPEND.getAlias() + CALLBACK_DELIMITER.getAlias() + cardId));
//        } else {
//            buttons.add(button(Callback.BURY.getText(), Callback.BURY.getAlias() + CALLBACK_DELIMITER.getAlias() + cardId));
//            buttons.add(button(Callback.SUSPEND.getText(), Callback.SUSPEND.getAlias() + CALLBACK_DELIMITER.getAlias() + cardId));
//        }

        buttons.add(button(Callback.DECK_MENU.getText(), Callback.DECK_MENU.getAlias() + CALLBACK_DELIMITER.getAlias() + deckId));
    ...
    public InlineKeyboardMarkup getShowAnswerKeyboard(Long cardId, Long deckId, Status currentStatus) {
        List<InlineKeyboardButton> buttons = new ArrayList<>(List.of(
                button(Callback.AGAIN.getText(), Callback.AGAIN.getAlias() + CALLBACK_DELIMITER.getAlias() + cardId + CALLBACK_DELIMITER.getAlias() + deckId),
                button(Callback.HARD.getText(), Callback.HARD.getAlias() + CALLBACK_DELIMITER.getAlias() + cardId + CALLBACK_DELIMITER.getAlias() + deckId),
                button(Callback.GOOD.getText(), Callback.GOOD.getAlias() + CALLBACK_DELIMITER.getAlias() + cardId + CALLBACK_DELIMITER.getAlias() + deckId),
                button(Callback.EASY.getText(), Callback.EASY.getAlias() + CALLBACK_DELIMITER.getAlias() + cardId + CALLBACK_DELIMITER.getAlias() + deckId),
                button(Callback.PREVIOUS.getText(), Callback.PREVIOUS.getAlias() + CALLBACK_DELIMITER.getAlias() + cardId),
                button(Callback.EDIT_EXISTING_CARD.getText(), Callback.EDIT_EXISTING_CARD.getAlias() + CALLBACK_DELIMITER.getAlias() + cardId)
...
//        }
    ...
    public InlineKeyboardMarkup getCardDraftConfirmationKeyboard(Long deckId) {
        List<InlineKeyboardButton> buttons = List.of(
                button(Callback.CONFIRM_CARD_CREATION.getText(), Callback.CONFIRM_CARD_CREATION.getAlias() + CALLBACK_DELIMITER.getAlias() + deckId),
                ...
                button(Callback.CANCEL_CARD_CREATION.getText(), Callback.CANCEL_CARD_CREATION.getAlias() + CALLBACK_DELIMITER.getAlias() + deckId)
        );
    ...
    public InlineKeyboardMarkup getExistingCardEditKeyboard(Long cardId, Long deckId) {
        List<InlineKeyboardButton> buttons = List.of(
                button(Callback.EDIT_EXISTING_CARD_FRONT.getText(),
                        Callback.EDIT_EXISTING_CARD_FRONT.getAlias() + CALLBACK_DELIMITER.getAlias() + cardId),
                button(Callback.EDIT_EXISTING_CARD_BACK.getText(),
                ...
                button(Callback.DECK_MENU.getText(), Callback.DECK_MENU.getAlias() + CALLBACK_DELIMITER.getAlias() + deckId),
                button(Callback.DELETE_CARD.getText(),
                        Callback.DELETE_CARD.getAlias() +
                                CALLBACK_DELIMITER.getAlias() + cardId +
                                CALLBACK_DELIMITER.getAlias() + deckId)
        );
        return InlineKeyboardMarkup.builder()
    ...
    public InlineKeyboardMarkup getBackToDeckListKeyboard() {
        List<InlineKeyboardButton> buttons = List.of(
                button("Вернуться к списку колод", Callback.DECK_LIST.getAlias())
        );
        return InlineKeyboardMarkup.builder()
                .keyboard(createDynamicRows(buttons, List.of(1)))
                .build();

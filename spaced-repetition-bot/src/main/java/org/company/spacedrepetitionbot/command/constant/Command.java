...
public enum Command {
    ...
    HELP("help", "Показывает все команды.\n/help [название команды]\nдля подробной информации",
            "/help\n/help [название команды]", Set.of(0, 1)),
    ...
    UNDO("undo", "Отменить последнюю команду", "/undo - чтобы удалить последнюю выполненную команду\n/undo [идентификатор команды] - чтобы удалить последнюю выполненную команду с указанным идентификатором", Set.of(0, 1)),

    ADD_CARD("addCard", "Добавить карточку в колоду",
            "/addCard [название колоды] [вопрос] [ответ]", Set.of(3)),
    DELETE_CARD("deleteCard", "Удалить карточку из колоды",
            "/deleteCard [название колоды] [начало вопроса]", Set.of(2)),
    EDIT_CARD_FRONT("editCardFront", "Редактировать вопрос карточки",
            "/editCardFront [название колоды] [текущий вопрос] [новый вопрос]\n", Set.of(3)),
    EDIT_CARD_BACK("editCardBack", "Редактировать ответ карточки",
            "/editCardBack [название колоды] [начало вопроса] [новый ответ]\n", Set.of(3)),
    MOVE_CARD("moveCard", "Переместить карточку в другую колоду",
            "/moveCard [название колоды] [начало вопроса] [новая колода]\n", Set.of(3)),
    SHOW_CARD("showCard", "Получить карточку из колоды",
            "/showCard [название колоды] [начало вопроса]", Set.of(2)),
    SHOW_ALL_CARDS("showAllCards", "Получить все карточки из колоды",
            "/showAllCards [название колоды]", Set.of(1)),

    ADD_DECK("addDeck", "Добавить колоду",
            "/addDeck [название колоды]", Set.of(1)),
    DELETE_DECK("deleteDeck", "Удалить колоду",
            "/deleteDeck [название колоды]", Set.of(1)),
    EDIT_DECK("editDeck", "Редактировать колоду",
            "/editDeck [текущее название колоды] [новое название]", Set.of(2)),
    SHOW_DECK("showDeck", "Показать колоду",
            "/showDeck [название колоды]", Set.of(1)),
    SHOW_ALL_DECKS("showAllDecks", "Показать все колоды",
            "/showAllDecks", Set.of(0));
